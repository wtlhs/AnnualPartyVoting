...
exports.VotePageRouterUtils = exports.VotingPageRouter = void 0;
exports.createVotePageRouter = createVotePageRouter;
...
class VotingPageRouter {
    ...
    parseURLParams(url) {
        try {
            ...
            const rawParams = (0, validation_1.decodeURLParams)(queryString);
            ...
            const category = rawParams.category ? (0, validation_1.sanitizeInput)(rawParams.category) : undefined;
            const timestamp = rawParams.timestamp ? (0, validation_1.sanitizeInput)(rawParams.timestamp) : undefined;
            // Construct vote page parameters
            const votePageParams = {
    ...
    validateParams(params) {
        ...
        return (0, validation_1.validateVotePageParams)(params);
    }
    /**
     ...
     */
    extractAndSanitizeParam(rawParams, paramName) {
        const value = rawParams[paramName];
        if (!value || typeof value !== 'string') {
            return '';
        }
        return (0, validation_1.sanitizeInput)(value);
    }
    /**
     ...
     */
    extractParameter(url, paramName) {
        try {
            const params = this.parseURLParams(url);
            switch (paramName) {
                case 'candidate_id':
    ...
    hasValidVotingParams(url) {
        try {
            ...
            return !!(params.candidateId &&
                ...
                params.source &&
                qr_code_voting_1.URL_VALIDATION_RULES.VALID_SOURCES.includes(params.source));
        }
        catch (error) {
            return false;
        }
 ...
 */
exports.default = VotingPageRouter;
//# sourceMappingURL=vote-page-router.js.map